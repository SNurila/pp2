...
class Coin(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.transform.scale(pygame.image.load("Coin.png"), (64, 64)) 
...
class Label(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.font = pygame.font.SysFont('Comic Sans MS', 30)  # Define font

    def draw(self, surface):
        """Draw the score on the screen."""
        text_surface = self.font.render(f'Score: {self.score}', False, (0, 0, 0))
        surface.blit(text_surface, (10, 10))  # Adjust position as needed
